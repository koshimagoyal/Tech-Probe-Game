...
try
{
	...
	while(rs.next())
	{
		...
		if(fl<1)
		{
		 	...
		 	{
			 	System.out.print("hy");
				session.setAttribute("C","Hints have been used three times.");
				%>
			 	<jsp:forward page="level1ques2.jsp"></jsp:forward>
			 	<%
		 	...
		 	{
		 		f=fl+1;
		 	String s2 = "update registration set flag1='"+f+"' where login_id='"+id+"'";
			...
			conn.setAutoCommit(true);
				...
				{
					System.out.print("hy");
					response.sendRedirect("level1ques2.jsp?message=your hint");
				...
				{
					System.out.print("hy");
					session.setAttribute("D","Hint has been used"); 
					%>
    			 	<jsp:forward page="level1ques2.jsp"></jsp:forward>
    			 	<%
				}
