...
try
{
	...
	while(rs.next())
	{
		...
		if(fl<1)
		{
		 	...
		 	{
			 	System.out.print("hy");
				session.setAttribute("G","Hints have been used three times.");
				%>
			 	<jsp:forward page="level1ques4.jsp"></jsp:forward>
			 	<% 
		 	...
		 	{
		 		f=fl+1;
		 		String s2 = "update registration set flag3='"+f+"' where login_id='"+id+"'";
				...
				{
					System.out.print("hy");
					response.sendRedirect("level1ques4.jsp?message=your hint");
				...
				{
					System.out.print("hy");
					session.setAttribute("H","Hint has been used once"); 
					%>
    			 	<jsp:forward page="level1ques4.jsp"></jsp:forward>
    			 	<% 
				}
