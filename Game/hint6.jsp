            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("M","Hints have been used three times");
            			 	%>
            			 	<jsp:forward page="level2ques3.jsp"></jsp:forward>
            			 	<% 
            		 	...
            		 	{
                                    f=fl+1;
                              String s2 = "update registration set flag6='"+f+"' where login_id='"+id+"'";
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level2ques3.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("N","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level2ques3.jsp"></jsp:forward>
                			 	<% 
            				}
