            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("S","Hints have been used three times");
            			 	%>
            			 	<jsp:forward page="level3ques2.jsp"></jsp:forward>
            			 	<% 
            		 	...
            		 	{
                                    f=fl+1;
                              String s2 = "update registration set flag9='"+f+"' where login_id='"+id+"'";
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level3ques2.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("T","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level3ques2.jsp"></jsp:forward>
                			 	<% 
            				}
