            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("O","Hints have been used three times");
            			 	%>
            			 	<jsp:forward page="level2ques4.jsp"></jsp:forward>
            			 	<% 
            		 	...
            		 	{
                                    f=fl+1;
                              String s2 = "update registration set flag7='"+f+"' where login_id='"+id+"'";
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level2ques4.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("P","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level2ques4.jsp"></jsp:forward>
                			 	<% 
            				}
