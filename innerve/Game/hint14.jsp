            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("AAA","Hints have been used three times");
            			 	%>
            			 	<jsp:forward page="level4ques3.jsp"></jsp:forward>
            			 	<% 
            		 	...
            		 	{
                                    f=fl+1;
                              String s2 = "update registration set flag14='"+f+"' where login_id='"+id+"'";
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level4ques3.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("BBB","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level4ques4.jsp"></jsp:forward>
                			 	<% 
            				}
            			}
            		}			
