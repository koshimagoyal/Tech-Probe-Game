            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("K","Hints have been three times");
            			 	%>
            			 	<jsp:forward page="level2ques2.jsp"></jsp:forward>
            			 	<% 
            		 	...
            		 	else
            		 	{
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level2ques2.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("L","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level2ques2.jsp"></jsp:forward>
                			 	<% 
            				}
