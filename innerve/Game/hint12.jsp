            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("Y","Hints have been used three times");
            			 	%>
            			 	<jsp:forward page="level4ques1.jsp"></jsp:forward>
            			 	<% 
            		 	...
            		 	{
                                    f=fl+1;
                              String s2 = "update registration set flag12='"+f+"' where login_id='"+id+"'";
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level4ques1.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("Z","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level4ques1.jsp"></jsp:forward>
                			 	<% 
            				}
