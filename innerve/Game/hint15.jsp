            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("CCC","Hints have been used three times");
            			 	%>
            		 	...
            		 	{
                                    f=fl+1;
                              String s2 = "update registration set flag15='"+f+"' where login_id='"+id+"'";
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level4ques4.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("DDD","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level4ques4.jsp"></jsp:forward>
                			 	<% 
            				}
