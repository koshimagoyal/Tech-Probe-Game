            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("I","Hints have been three times");
            			 	%>
            			 	<jsp:forward page="level2ques1.jsp"></jsp:forward>
            			 	<% 
            		 	...
            		 	{
                                    f=fl+1;
                                    String s2 = "update registration set flag4='"+f+"' where login_id='"+id+"'";
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level2ques1.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("J","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level2ques1.jsp"></jsp:forward>
                			 	<% 
            				}
