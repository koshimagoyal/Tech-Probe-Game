            ...
            try
            {
            	...
            	while(rs.next())
            	{
            		...
            		if(fl<1)
            		{
            		 	...
            		 	{
            			 	System.out.print("hy");
            			 	session.setAttribute("Er","Hints have been used three times");
            			 	%>
            		 	...
            		 	{
                                    f=fl+1;
                              String s2 = "update registration set flag13='"+f+"' where login_id='"+id+"'";
            				...
            				if(action==1)
            				{
            					...
            					response.sendRedirect("level4ques2.jsp?message=your hint");
            				...
            				{
            					System.out.print("hy");
            					session.setAttribute("On","Hint has been used once"); 
            					%>
                			 	<jsp:forward page="level4ques2.jsp"></jsp:forward>
                			 	<% 
            				}
